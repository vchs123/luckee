...
export const MELB_TRANSPORT: Experience[] = [
  {
  ...
  },
  {
    ...
    d: "From 1 June 2026 to 1 January 2027, all public transport across Victoria is half price. Full Fare daily cap drops from $11.40 to $5.70. Under-18s travel free with a Youth myki.",
    t: "Until 1 Jan 2027", col: "amber",
  },
  {
    e: "👶", cat: "Getting around", n: "Free travel for under-18s & seniors",
    d: "Under-18s travel free across all of Victoria with a Youth myki. Seniors, carers and DSP recipients travel free on weekends from February 2026.",
    t: "Ongoing", col: "melb",
  },
];

export const MELB_CULTURE: Experience[] = [
  {
...
export const MELB_CLASSES: Experience[] = [
  {
    e: "🏃", cat: "Classes & workshops", n: "City of Melbourne Free Fitness in the Park",
    d: "Monthly outdoor fitness sessions — zumba, tai chi, yoga, boxing, pilates, family fitness — led by rec-centre staff. Free refreshments afterward. Book online; all fitness levels welcome.",
    t: "Monthly sessions", col: "melb",
  },
  {
    e: "🧘", cat: "Classes & workshops", n: "lululemon community classes",
    d: "Free ambassador-led yoga, run club, pilates, boxing and strength sessions near Melbourne stores. Previously ran 20-week programs in the NGV garden. Check Eventbrite.",
    t: "Seasonal", col: "melb",
  },
  {
    e: "🔨", cat: "Classes & workshops", n: "Bunnings DIY workshops",
    d: "Free hands-on adult Make & Take workshops, garden hub sessions, and free weekend kids' DIY activities for ages 5+. Book online.",
    t: "Ongoing", col: "melb",
  },
  {
    e: "📱", cat: "Classes & workshops", n: "Today at Apple",
    d: "Free daily sessions in photography, music creation, coding and more, led by Creative Pros at Chadstone and other Melbourne Apple stores.",
    t: "Daily", col: "melb",
  },
  {
    e: "📖", cat: "Classes & workshops", n: "State Library walking tours",
    d: "Free Dome to Catacombs history tours almost daily. Book via the State Library website.",
    t: "Most days", col: "melb",
  },
];

export const MELB_OUTDOORS: Experience[] = [
  {
  ...
  },
  {
    ...
    d: "Free public WiFi at 500+ hotspots across Melbourne, Bendigo and Ballarat CBDs. Up to 1GB per device per day, no login, no pop-up ads. Fastest spots: State Library, Federation Square.",
    t: "Always free", col: "melb",
  },
  {
    e: "🏫", cat: "Markets & outdoors", n: "Melbourne Greeter Service",
    d: "City of Melbourne volunteers lead free orientation walks for visitors and locals. Pairs you with a local volunteer. Book via the City of Melbourne website.",
    t: "By booking", col: "melb",
  },
];
