    ...
    <footer className="ft">
      <div className="ft-i">
        ...
        <div className="ft-bot">
          ...
          <p className="ft-disco">Some links are affiliate referral links. Luckee may earn a commission if you sign up — at no extra cost to you. All freebie listings are editorially independent.</p>
        </div>
      </div>
    </footer>
  );
